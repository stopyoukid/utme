...
},{"../utme":9,"./FileSaver":4}],6:[function(require,module,exports){
"use strict";
...
},{"../utme.js":9}],7:[function(require,module,exports){
"use strict";
...
var utme = {
  ...
  runScenario: function(name, config) {
    ...
    return getScenario(toRun).then(function(scenario) {
      ...
      utme.state.run = $.extend({speed: '10'}, config);
...
},{"./Simulate":3,"./selectorFinder":7,"es6-promise":1}]},{},[4,5,6,7,8,9]);

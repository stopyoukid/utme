...
},{"./utils":9,"dup":3}],9:[function(require,module,exports){
/**
 * Polyfills
 */
...
function showScenarioForm(callback) {
    ...
    var cleanupInput = createLabeledTextArea('Cleanup Scenarios (Optional, Newline separated):', '');
    form.appendChild(cleanupInput);
    ...
    form.appendChild(createButton('Save', 'okButton', function(e) {
      ...
      var cleanup = cleanupInput.querySelector("textarea").value;
...
},{"./utme":11}],11:[function(require,module,exports){
(function (global){
var _ = require('./utils');
...
},{"./Simulate":3,"./selectorFinder":7,"./utils":9,"es6-promise":1}]},{},[8,7,11,10,4,5,6]);

...
},{"./ReactElement":115,"./ReactInstanceHandles":123,"./invariant":189,_process:3}],208:[function(a,b){(function(c){"use strict";var d=a("./emptyFunction"),e=d;"production"!==c.env.NODE_ENV&&(e=function(a,b){for(var c=[],d=2,e=arguments.length;e>d;d++)c.push(arguments[d]);if(void 0===b)throw new Error("`warning(condition, format, ...args)` requires a warning message argument");if(!a){var f=0;console.warn("Warning: "+b.replace(/%s/g,function(){return c[f++]}))}}),b.exports=e}).call(this,a("_process"))},{"./emptyFunction":170,_process:3}],209:[function(a,b){b.exports=a("./lib/React")},{"./lib/React":91}],210:[function(a,b){"use strict";var c=a("../utme"),d=a("filesaver.js");b.exports=c.registerSaveHandler(function(a){var b=new Blob([JSON.stringify(a,null," ")],{type:"text/plain;charset=utf-8"});d(b,a.name+".json")})},{"../utme":216,"filesaver.js":2}],211:[function(a){"use strict";function b(){return d.state&&d.state.testServer?d.state.testServer:c("utme_test_server")||"http://0.0.0.0:9043/"}function c(a){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var b=new RegExp("[\\?&]"+a+"=([^&#]*)"),c=b.exec(location.search);return null===c?"":decodeURIComponent(c[1].replace(/\+/g," "))}var d=a("../utme.js"),e={error:function(a,c,d){$.ajax({type:"POST",url:b()+"error",data:{data:a},dataType:"json"}),d.settings.get("consoleLogging")&&console.error(a)},success:function(a,c,d){$.ajax({type:"POST",url:b()+"success",data:{data:a},dataType:"json"}),d.settings.get("consoleLogging")&&console.log(a)},log:function(a,c,d){$.ajax({type:"POST",url:b()+"log",data:{data:a},dataType:"json"}),d.settings.get("consoleLogging")&&console.log(a)},loadScenario:function(a,c){$.ajax({jsonp:"callback",contentType:"application/json; charset=utf-8",crossDomain:!0,url:b()+"scenario/"+a,dataType:"jsonp",success:function(a){c(a)}})},saveScenario:function(a){$.ajax({type:"POST",url:b()+"scenario",data:JSON.stringify(a,null," "),dataType:"json",contentType:"application/json"})},loadSettings:function(a,c){$.ajax({contentType:"text/plan; charset=utf-8",crossDomain:!0,url:b()+"settings",dataType:"json",success:function(b){a(b)},error:function(a){c(a)}})}};d.registerReportHandler(e),d.registerLoadHandler(e.loadScenario),d.registerSaveHandler(e.saveScenario),d.registerSettingsLoadHandler(e.loadSettings)},{"../utme.js":216}],212:[function(a,b){"use strict";function c(a,b){function c(a,c){for(var d=0,e=b.querySelectorAll(c),f=0;f<e.length;f++)if(e[f]===a){d=f;break}return d}if(!a||!a.tagName)throw new TypeError("Element expected");for(var d,f=e(a).selector,g=f===a.tagName.toLowerCase(),h=a;null!=h.parentElement&&!d;){h=h.parentElement;var i=e(h).selector;i!==h.tagName.toLowerCase()&&(d=i+(h===a.parentElement&&g?" > ":" ")+f)}var j=[];return d&&j.push(d+":eq("+c(a,d)+")"),j.push(f+":eq("+c(a,f)+")"),j}function d(a){var b=a.getAttribute("class");return b=b&&b.replace("utme-verify",""),b=b&&b.replace("utme-ready",""),b&&b.trim().length?(b=b.replace(/\s+/g," "),b=b.replace(/^\s+|\s+$/g,""),b.trim().split(" ")):[]}function e(a){var b=[],c=null,e=null,f=null,g=null,h=null;if(a.id)c="[id='"+a.id+"']";else{c=a.tagName.toLowerCase();var i=d(a);i.length&&(c+="."+i.join("."))}if((e=a.getAttribute("title"))?c+='[title="'+e+'"]':(f=a.getAttribute("alt"))?c+='[alt="'+f+'"]':(g=a.getAttribute("name"))&&(c+='[name="'+g+'"]'),(h=a.getAttribute("value"))&&(c+='[value="'+h+'"]'),b.unshift({element:a,selector:c}),!b.length)throw new Error("Failed to identify CSS selector");return b[0]}b.exports=c},{}],213:[function(a,b){"use strict";function c(a){this.setDefaults(a||{})}var d=a("./utils"),e="utme-settings";c.prototype={readSettingsFromLocalStorage:function(){var a=localStorage.getItem(e),b={};return a&&(b=JSON.parse(a)),b},setDefaults:function(a){var b=this.readSettingsFromLocalStorage(),c=d.extend({},a||{});this.settings=d.extend({},d.extend(c,b)),this.defaultSettings=a},set:function(a,b){this.settings[a]=b,this.save()},get:function(a){return this.settings[a]},save:function(){localStorage.setItem(e,JSON.stringify(this.settings))},resetDefaults:function(){var a=this.defaultSettings;a&&(this.settings=d.extend({},a),this.save())}},b.exports=c},{"./utils":215}],214:[function(a,b){"use strict";var c=a("./utils"),d={event:function(a,b,d){var e;document.createEvent?(e=document.createEvent("HTMLEvents"),e.initEvent(b,"mouseenter"!=b&&"mouseleave"!=b,!0),c.extend(e,d),a.dispatchEvent(e)):(e=document.createEventObject(),a.fireEvent("on"+b,e))},keyEvent:function(a,b,d){var e,f={bubbles:!0,cancelable:!0,view:window,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,keyCode:0,charCode:0};if(c.extend(f,d),document.createEvent)try{e=document.createEvent("KeyEvents"),e.initKeyEvent(b,f.bubbles,f.cancelable,f.view,f.ctrlKey,f.altKey,f.shiftKey,f.metaKey,f.keyCode,f.charCode),a.dispatchEvent(e)}catch(g){e=document.createEvent("Events"),e.initEvent(b,f.bubbles,f.cancelable),c.extend(e,{view:f.view,ctrlKey:f.ctrlKey,altKey:f.altKey,shiftKey:f.shiftKey,metaKey:f.metaKey,keyCode:f.keyCode,charCode:f.charCode}),a.dispatchEvent(e)}}};d.keypress=function(a,b){var c=b.charCodeAt(0);this.keyEvent(a,"keypress",{keyCode:c,charCode:c})},d.keydown=function(a,b){var c=b.charCodeAt(0);this.keyEvent(a,"keydown",{keyCode:c,charCode:c})},d.keyup=function(a,b){var c=b.charCodeAt(0);this.keyEvent(a,"keyup",{keyCode:c,charCode:c})};for(var e=["click","focus","blur","dblclick","input","change","mousedown","mousemove","mouseout","mouseover","mouseup","mouseenter","mouseleave","resize","scroll","select","submit","load","unload"],f=e.length;f--;){var g=e[f];d[g]=function(a){return function(b,c){this.event(b,a,c)}}(g)}b.exports=d},{"./utils":215}],215:[function(a,b){"use strict";!function(){var a=Array.prototype,b=a.slice,c=Function.prototype;c.bind||(c.bind=function(a){function c(){var c=d.prototype&&this instanceof d;return d.apply(!c&&a||this,e.concat(b.call(arguments)))}var d=this,e=b.call(arguments,1);return c.prototype=d.prototype,c})}(),b.exports={extend:function(a,b){if(b)for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c]);return a},map:function(a,b,c){var d=a.length>>>0,e=new Array(d),f=0;for(c||(c=a);d>f;)e[f]=b.call(c,a[f],f,a),f++;return e}}},{}],216:[function(a,b){(function(c){"use strict";function d(a){return new z(function(b){if(0===G.length)for(var c=L.state,d=0;d<c.scenarios.length;d++)c.scenarios[d].name===a&&b(c.scenarios[d]);else G[0](a,function(a){b(a)})})}function e(a){var b=a.setup,c=b&&b.scenarios;return c?z.all(y.map(c,function(a){return d(a).then(function(a){return a=JSON.parse(JSON.stringify(a)),h(a).then(function(){return a.steps})})})):z.resolve([])}function f(a){var b=a.cleanup,c=b&&b.scenarios;return c?z.all(y.map(c,function(a){return d(a).then(function(a){return a=JSON.parse(JSON.stringify(a)),h(a).then(function(){return a.steps})})})):z.resolve([])}function g(a){for(var b,c=[],d=0;d<a.length;d++){var e=a[d];if(d>0)for(var f=0;f<a.length;f++){var g=e[f],h=f>0?g.timeStamp-e[f-1].timeStamp:50;b+=h,e[f].timeStamp=b}else b=e[d].timeStamp;c=c.concat(e)}return c}function h(a){return z.all([e(a),f(a)]).then(function(b){var c=b[0].concat([a.steps],b[1]);a.steps=g(c)})}function i(a,b,c){L.broadcast("RUNNING_STEP"),c=c||{};var d=a.steps[b],e=L.state;if(d&&"PLAYING"==e.status)if(e.run.scenario=a,e.run.stepIndex=b,"load"==d.eventName){var f=d.data.url.protocol+"//"+d.data.url.host,g=d.data.url.search,h=d.data.url.hash;g&&!g.charAt("?")&&(g="?"+g);var i=location.protocol+"//"+location.host+location.search===f+g;window.location.replace(f+h+g),console.log(location.protocol+location.host+location.search),console.log(d.data.url.protocol+d.data.url.host+d.data.url.search),i&&window.location.reload(!0)}else if("timeout"==d.eventName)e.autoRun&&o(a,b,c,d.data.amount);else{var j=d.data.locator,q=a.steps,r=p(d);if("undefined"==typeof c[r]&&"realtime"!=L.state.run.speed){for(var s,t=!1,u=q.length-1;u>b;u--){var v=q[u],w=p(v);if(r===w)if(s){if(l(v)){t=!1;break}}else s=v.timeStamp-d.timeStamp,t=!k(v)&&D>s}c[r]=t}c[p(d)]?o(a,b,c):m(a,d,j,n(a,b)).then(function(f){var g=f[0],h=g.tagName.toLowerCase(),i="input"===h||"textarea"===h||g.getAttribute("contenteditable");if(I.indexOf(d.eventName)>=0){var k={};d.data.button&&(k.which=k.button=d.data.button),"click"==d.eventName?$(g).trigger("click"):"focus"!=d.eventName&&"blur"!=d.eventName||!g[d.eventName]?A[d.eventName](g,k):g[d.eventName](),"undefined"!=typeof d.data.value&&(g.value=d.data.value,i&&A.event(g,"input"),A.event(g,"change"))}if("keypress"==d.eventName){var l=String.fromCharCode(d.data.keyCode);A.keypress(g,l),A.keydown(g,l),g.value=d.data.value,A.event(g,"change"),A.keyup(g,l),i&&A.event(g,"input")}"validate"==d.eventName&&L.reportLog("Validate: "+JSON.stringify(j.selectors)+" contains text '"+d.data.text+"'"),e.autoRun&&o(a,b,c)},function(f){"validate"==d.eventName?(L.reportLog("Validate: "+f),L.stopScenario(!1)):k(d)?(L.reportError("Failed on step: "+b+"  Event: "+d.eventName+" Reason: "+f),L.stopScenario(!1)):(x.get("verbose")&&L.reportLog(f),e.autoRun&&o(a,b,c))})}}function j(a){var b=document.querySelector(a);return new z(function(c,d){try{if(!window.angular)throw new Error("angular could not be found on the window");if(angular.getTestability)angular.getTestability(b).whenStable(c);else{if(!angular.element(b).injector())throw new Error("root element ("+a+") has no injector. this may mean it is not inside ng-app.");angular.element(b).injector().get("$browser").notifyWhenNoOutstandingRequests(c)}}catch(e){d(e)}})}function k(a){return"mouseleave"!=a.eventName&&"mouseout"!=a.eventName&&"mouseenter"!=a.eventName&&"mouseover"!=a.eventName&&"blur"!=a.eventName&&"focus"!=a.eventName}function l(a){var b=a.eventName;return 0!==b.indexOf("mouse")||0===b.indexOf("mousedown")||0===b.indexOf("mouseup")}function m(a,b,d,e){var f;return new z(function(a,g){function h(){f||(f=(new Date).getTime());var c,i=!1,j=!1,l=!1,m=d.selectors.slice(0),n=b.data.text,o=b.data.comparison||"equals";m.unshift('[data-unique-id="'+d.uniqueId+'"]');for(var p=0;p<m.length;p++){var q=m[p];if(k(b)&&(q+=":visible"),c=$(q),1==c.length){if("undefined"==typeof n){j=!0,c.attr("data-unique-id",d.uniqueId);break}var r=$(c[0]).text();if("equals"===o&&r===n||"contains"===o&&r.indexOf(n)>=0){j=!0;break}l=!0;break}c.length>1&&(i=!0)}if(j)a(c);else if(k(b)&&(new Date).getTime()-f<5*e)setTimeout(h,50);else{var s="";s=i?"Could not find appropriate element for selectors: "+JSON.stringify(d.selectors)+" for event "+b.eventName+".  Reason: Found Too Many Elements":l?"Could not find appropriate element for selectors: "+JSON.stringify(d.selectors)+" for event "+b.eventName+".  Reason: Text doesn't match.  \nExpected:\n"+n+"\nbut was\n"+c.text()+"\n":"Could not find appropriate element for selectors: "+JSON.stringify(d.selectors)+" for event "+b.eventName+".  Reason: No elements found",g(s)}}var i=D/("realtime"==L.state.run.speed?"1":L.state.run.speed);c.angular?j("[ng-app]").then(function(){"realtime"===L.state.run.speed?setTimeout(h,e):"fastest"===L.state.run.speed?h():setTimeout(h,Math.min(e*L.state.run.speed,i))}):"realtime"===L.state.run.speed?setTimeout(h,e):"fastest"===L.state.run.speed?h():setTimeout(h,Math.min(e*L.state.run.speed,i))})}function n(a,b){return b>0?"validate"==a.steps[b-1].eventName?0:a.steps[b].timeStamp-a.steps[b-1].timeStamp:0}function o(a,b,c,d){setTimeout(function(){a.steps.length>b+1?i(a,b+1,c):L.stopScenario(!0)},d||0)}function p(a){return a&&a.data&&a.data.locator&&a.data.locator.uniqueId}function q(a,b){$(a).toggleClass("utme-verify",b)}function r(a,b){$(a).toggleClass("utme-ready",b)}function s(a){return 0==$(a).parents("label").length||"input"==a.nodeName.toLowerCase()}function t(){function a(a){if(!a.isTrigger&&L.isRecording()&&a.target.hasAttribute&&!a.target.hasAttribute("data-ignore")&&0==$(a.target).parents("[data-ignore]").length){var b=a.which;c.hasOwnProperty(b)&&(b=c[b]),b=!a.shiftKey&&b>=65&&90>=b?String.fromCharCode(b+32):a.shiftKey&&d.hasOwnProperty(b)?d[b]:String.fromCharCode(b),L.registerEvent("keypress",{locator:L.createElementLocator(a.target),key:b,prevValue:a.target.value,value:a.target.value+b,keyCode:a.keyCode})}}for(var b=0;b<I.length;b++)document.addEventListener(I[b],function(a){var b=function(b){if(!b.isTrigger&&L.isRecording()&&b.target.hasAttribute&&!b.target.hasAttribute("data-ignore")&&0==$(b.target).parents("[data-ignore]").length&&s(b.target)){var c=L.state.steps.length,d={locator:L.createElementLocator(b.target)};if((b.which||b.button)&&(d.button=b.which||b.button),"mouseover"==a&&(q(b.target,!0),M.push({element:b.target,timer:setTimeout(function(){r(b.target,!0),q(b.target,!1)},500)})),"mouseout"==a){for(var e=0;e<M.length;e++)if(M[e].element==b.target){clearTimeout(M[e].timer),M.splice(e,1);break}q(b.target,!1),r(b.target,!1)}"change"==a&&(d.value=b.target.value),L.registerEvent(a,d,c)}};return(L.eventListeners=L.eventListeners||{})[a]=b,b}(I[b]),!0);var c={188:"44",109:"45",190:"46",191:"47",192:"96",220:"92",222:"39",221:"93",219:"91",173:"45",187:"61",186:"59",189:"45"},d={96:"~",49:"!",50:"@",51:"#",52:"$",53:"%",54:"^",55:"&",56:"*",57:"(",48:")",45:"_",61:"+",91:"{",93:"}",92:"|",59:":",39:'"',44:"<",46:">",47:"?"};document.addEventListener("keypress",a,!0),(L.eventListeners=L.eventListeners||{}).keypress=a}function u(a){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var b=new RegExp("[\\?&]"+a+"=([^&#]*)"),c=b.exec(location.search);return null===c?"":decodeURIComponent(c[1].replace(/\+/g," "))}function v(){"complete"==document.readyState&&L.init().then(function(){t(),L.isRecording()&&L.registerEvent("load",{url:{protocol:window.location.protocol,host:window.location.host,search:window.location.search,hash:window.location.hash}})})}var w,x,y=a("./utils"),z=a("es6-promise").Promise,A=a("./simulate"),B=a("./selectorFinder"),C=a("./settings"),D=500,E=[],F=[],G=[],H=[],I=["click","focus","blur","dblclick","mousedown","mouseenter","mouseleave","mouseout","mouseover","mouseup","change"],J=function(){function a(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return function(){return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()}}(),K=[],L={state:w,init:function(){var a=u("utme_scenario");return L.loadSettings().then(function(){a?(localStorage.clear(),w=L.state=L.loadStateFromStorage(),L.broadcast("INITIALIZED"),setTimeout(function(){w.testServer=u("utme_test_server"),w.autoRun=!0;var b=u("utme_run_config");b&&(b=JSON.parse(b)),b=b||{};var c=u("utme_run_speed")||x.get("runner.speed");c&&(b.speed=c),L.runScenario(a,b)},2e3)):(w=L.state=L.loadStateFromStorage(),L.broadcast("INITIALIZED"),"PLAYING"===w.status?o(w.run.scenario,w.run.stepIndex):w.status&&"INITIALIZING"!==w.status||(w.status="LOADED"))})},broadcast:function(a,b){if(K&&K.length)for(var c=0;c<K.length;c++)K[c](a,b)},startRecording:function(){"RECORDING"!=w.status&&(w.status="RECORDING",w.steps=[],L.reportLog("Recording Started"),L.broadcast("RECORDING_STARTED"),L.registerEvent("load",{url:{protocol:window.location.protocol,host:window.location.host,search:window.location.search,hash:window.location.hash}}))},runScenario:function(a,b){var c=a||prompt("Scenario to run"),e=a?!0:"y"!=prompt("Would you like to step through each step (y|n)?");return d(c).then(function(c){c=JSON.parse(JSON.stringify(c)),L.state.run=y.extend({speed:"10"},b),h(c).then(function(){w.autoRun=e===!0,w.status="PLAYING",L.reportLog("Starting Scenario '"+a+"'",c),L.broadcast("PLAYBACK_STARTED"),i(c,0)})})},runNextStep:o,stopScenario:function(a){var b=w.run&&w.run.scenario;delete w.run,w.status="LOADED",L.broadcast("PLAYBACK_STOPPED"),L.reportLog("Stopping Scenario"),b&&(a?L.reportSuccess("[SUCCESS] Scenario '"+b.name+"' Completed!"):(L.reportLog("Stopping on page "+window.location.href),L.reportError("[FAILURE] Scenario '"+b.name+"' Stopped!")))},createElementLocator:function(a){var b=a.getAttribute("data-unique-id")||J();a.setAttribute("data-unique-id",b);var c=(a.cloneNode().outerHTML,[]);return c="BODY"==a.tagName.toUpperCase()||"HTML"==a.tagName.toUpperCase()?[a.tagName]:B(a,document.body),{uniqueId:b,selectors:c}},registerEvent:function(a,b,c){(L.isRecording()||L.isValidating())&&("undefined"==typeof c&&(c=L.state.steps.length),w.steps[c]={eventName:a,timeStamp:(new Date).getTime(),data:b},L.broadcast("EVENT_REGISTERED"))},reportLog:function(a,b){if(F&&F.length)for(var c=0;c<F.length;c++)F[c].log(a,b,L)},reportError:function(a,b){if(F&&F.length)for(var c=0;c<F.length;c++)F[c].error(a,b,L)},reportSuccess:function(a,b){if(F&&F.length)for(var c=0;c<F.length;c++)F[c].success(a,b,L)},registerListener:function(a){K.push(a)},registerSaveHandler:function(a){E.push(a)},registerReportHandler:function(a){F.push(a)},registerLoadHandler:function(a){G.push(a)},registerSettingsLoadHandler:function(a){H.push(a)},isRecording:function(){return 0===L.state.status.indexOf("RECORDING")},isPlaying:function(){return 0===L.state.status.indexOf("PLAYING")},isValidating:function(a){return"undefined"!=typeof a&&(L.isRecording()||L.isValidating())&&(L.state.status=a?"VALIDATING":"RECORDING",L.broadcast("VALIDATION_CHANGED")),0===L.state.status.indexOf("VALIDATING")},stopRecording:function(a){if(a!==!1){var b={steps:w.steps};if(y.extend(b,a),b.name||(b.name=prompt("Enter scenario name")),b.name&&(w.scenarios.push(b),E&&E.length))for(var c=0;c<E.length;c++)E[c](b,L)}w.status="LOADED",L.broadcast("RECORDING_STOPPED"),L.reportLog("Recording Stopped",b)},loadSettings:function(){return x=L.settings=new C,H.length>0&&!u("utme_scenario")?new z(function(a){H[0](function(b){x.setDefaults(b),a()},function(){a()})}):z.resolve()},loadStateFromStorage:function(){var a=localStorage.getItem("utme");return w=a?JSON.parse(a):{status:"INITIALIZING",scenarios:[]}},saveStateToStorage:function(a){a?localStorage.setItem("utme",JSON.stringify(a)):localStorage.removeItem("utme")},unload:function(){L.saveStateToStorage(w)}},M=[];v(),document.addEventListener("readystatechange",v),window.addEventListener("unload",function(){L.unload()},!0),window.addEventListener("error",function(a){L.reportLog("Script Error: "+a.message+":"+a.url+","+a.line+":"+a.col)}),b.exports=L}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./selectorFinder":212,"./settings":213,"./simulate":214,"./utils":215,"es6-promise":1}],217:[function(a,b){"use strict";function c(a){for(var b=0;b<e.length;b++)if(e[b].element===a)return e[b].container}var d=a("react"),e=[];b.exports={append:function(a,b){var c=(document.createElement("style"),document.createElement("div"));return c.className="utme-ui"+(b?" "+b:""),document.body.appendChild(c),d.render(a,c),e.push({container:c,element:a}),a},appendComponent:function(a,b,c){return this.append(d.createElement(a,b),c)},remove:function(a){var b=c(a);b&&(d.unmountComponentAtNode(b),setTimeout(function(){document.body.removeChild(b)}))}}},{react:209}],218:[function(a,b){"use strict";var c=a("react"),d=a("react-bootstrap"),e=d.ButtonGroup,f=d.Button,g=d.Glyphicon,h=a("./modals/create-scenario-modal.jsx"),i=a("./settings/settings-modal.jsx"),j=c.createClass({displayName:"ControlPanel",propTypes:{utme:c.PropTypes.object.isRequired},getInitialState:function(){return{disablePanel:!1}},componentDidMount:function(){var a=this;this.props.utme.registerListener(function(){a.forceUpdate()})},componentWillUnmount:function(){},render:function(){return c.createElement("div",null,this.renderButtons())},renderButtons:function(){var a=this.props.utme;return a.isRecording()||a.isValidating()?this.renderRecorder():a.isPlaying()?this.renderPlayer():this.renderDefault()},renderDefault:function(){return c.createElement(e,{bsSize:"small"},c.createElement(f,{ref:"settingsButton",onClick:this.showSettings,disabled:this.state.disablePanel},c.createElement(g,{glyph:"cog"})),c.createElement(f,{ref:"recordButton",onClick:this.recordScenario,disabled:this.state.disablePanel},c.createElement("span",null,"⬤")),c.createElement(f,{ref:"runButton",onClick:this.runScenario,disabled:this.state.disablePanel},c.createElement(g,{glyph:"play"})))},renderRecorder:function(){return c.createElement(e,{bsSize:"small"},c.createElement(f,{ref:"timeoutButton",onClick:this.addTimeout,disabled:this.state.disablePanel},c.createElement(g,{glyph:"time"})),c.createElement(f,{ref:"stopButton",onClick:this.recordScenario,disabled:this.state.disablePanel},c.createElement(g,{style:{color:"red"},glyph:"stop"})),c.createElement(f,{ref:"validateButton",onClick:this.validate,disabled:this.state.disablePanel},c.createElement(g,{glyph:"ok-sign",style:this.props.utme.isValidating()?{color:"green"}:{}})))},renderPlayer:function(){return c.createElement(e,{bsSize:"small"},c.createElement(f,{ref:"stopButton",onClick:this.runScenario,disabled:this.state.disablePanel},c.createElement(g,{glyph:"stop"})),c.createElement(f,{ref:"pauseButton",onClick:this.pauseScenario,disabled:this.state.disablePanel},c.createElement(g,{glyph:this.props.utme.state.autoRun?"pause":"play"})),c.createElement(f,{ref:"stepButton",onClick:this.step,disabled:this.props.utme.isPlaying()||this.state.disablePanel},c.createElement(g,{glyph:"step-forward"})))},showSettings:function(){var a=this;this.setState({disablePanel:!0}),i.open({settings:this.props.utme.settings}).then(function(){a.setState({disablePanel:!1})})},recordScenario:function(){var a=this.props.utme;a.isRecording()||a.isValidating()?(a.isValidating()&&a.isValidating(!1),h.open().then(function(b){b?"save"===b.action&&a.stopRecording(b.scenario):a.stopRecording(!1)})):a.startRecording()},addTimeout:function(){var a=this.props.utme;a.isRecording()&&a.registerEvent("timeout",{amount:parseInt(prompt("How long in ms?"),10)})},validate:function(){var a=this.props.utme,b=a.isValidating();(a.isRecording()||b)&&(b&&toggleHighlight($(".utme-verify"),!1),a.isValidating(!b))},runScenario:function(){var a=this.props.utme;a.isRecording()||a.isPlaying()||a.isValidating()?a.stopScenario(!1):a.runScenario()},pauseScenario:function(){var a=this.props.utme;a.state.autoRun=!a.state.autoRun,this.forceUpdate()},step:function(){var a=this.props.utme;a.runNextStep(a.state.runningScenario,a.state.runningStep)}});b.exports=j},{"./modals/create-scenario-modal.jsx":220,"./settings/settings-modal.jsx":222,react:209,"react-bootstrap":53}],219:[function(a,b){"use strict";b.exports={componentDidMount:function(){this.updateDOM(this.getDOMNode())},componentDidUpdate:function(){this.updateDOM(this.getDOMNode())},updateDOM:function(a){for(var b=a.children.length;b-->0;)this.updateDOM(a.children[b]);this.addIgnoreAttribute(a)},addIgnoreAttribute:function(a){a.setAttribute("data-ignore","true")}}},{}],220:[function(a,b){"use strict";var c=a("react"),d=a("react-bootstrap"),e=d.Modal,f=d.Input,g=d.Button,h=a("./modal-launcher.jsx"),i=a("../mixins/UtmeMixin"),j=c.createClass({displayName:"CreateModal",mixins:[i],render:function(){return c.createElement(e,{title:"Save Scenario Recording",onRequestHide:function(){},className:"utme-create-modal"},c.createElement("div",{className:"modal-body"},c.createElement("form",{"data-ignore":"true",ref:"form"},c.createElement(f,{type:"text",label:"Scenario Name",ref:"scenarioName"}),c.createElement(f,{type:"text",label:"Description (Optional):",ref:"description"}),c.createElement(f,{type:"text",label:"Setup Scenarios (Optional, Newline separated):",ref:"setupScenarios"}),c.createElement(f,{type:"text",label:"Cleanup Scenarios (Optional, Newline separated):",ref:"cleanupScenarios"}))),c.createElement("div",{className:"modal-footer","data-ignore":"true"},c.createElement(g,{className:"pull-left",ref:"resetDefaultsButton",onClick:this.cancel},"Cancel"),c.createElement(g,{ref:"continueButton",onClick:this.continueScenario},"Continue"),c.createElement(g,{bsStyle:"primary",ref:"saveButton",onClick:this.saveScenario},"Save")))},cancel:function(){this.props.onClose()},saveScenario:function(a){var b=(this.refs.form,this.refs.setupScenarios.getValue()),c=(this.refs.cleanupScenarios.getValue(),{name:this.refs.scenarioName.getValue(),description:this.refs.description.getValue()});b&&(c.setup={scenarios:b.split("\n")}),a.stopPropagation(),this.props.onClose({action:"save",scenario:c})},continueScenario:function(){this.props.onClose({action:"continue"})}});b.exports=h(j)},{"../mixins/UtmeMixin":219,"./modal-launcher.jsx":221,react:209,"react-bootstrap":53}],221:[function(a,b){"use strict";var c=a("../../../js/utils"),d=a("es6-promise").Promise,e=a("../../body");b.exports=function(a){return{open:function(b){return new d(function(d){var f=e.appendComponent(a,c.extend({onClose:function(a){setTimeout(function(){e.remove(f),d(a)})}},b))})["catch"](function(a){throw a})}}}},{"../../../js/utils":215,"../../body":217,"es6-promise":1}],222:[function(a,b){"use strict";var c=a("react"),d=a("react-bootstrap"),e=d.Modal,f=d.Button,g=d.TabPane,h=d.TabbedArea,i=d.Input,j=d.Grid,k=d.Col,l=d.Row,m=a("../modals/modal-launcher.jsx"),n=a("../mixins/UtmeMixin"),o="recorder.events.",p=c.createClass({displayName:"CreateModal",mixins:[n],propTypes:{settings:c.PropTypes.object.isRequired},render:function(){return c.createElement(e,{title:"Settings",onRequestHide:this.props.onClose,className:"utme-settings"},c.createElement("div",{className:"modal-body"},c.createElement("form",{className:"utme-settings-form"},c.createElement(h,{defaultActiveKey:1},c.createElement(g,{eventKey:1,tab:"Recording"},c.createElement("strong",null,"Recorded Events"),c.createElement(j,{fluid:!0},c.createElement(l,null,c.createElement(k,{xs:6},this.renderSetting("checkbox","Change","change"),this.renderSetting("checkbox","Focus","focus"),this.renderSetting("checkbox","Blur","blur"),this.renderSetting("checkbox","Click","record-click"),this.renderSetting("checkbox","Double Click","dblclick")),c.createElement(k,{xs:6},this.renderSetting("checkbox","Mouse Down","mousedown"),this.renderSetting("checkbox","Mouse Up","mousedown"),this.renderSetting("checkbox","Mouse Enter","mouseenter"),this.renderSetting("checkbox","Mouse Leave","mouseleave"),this.renderSetting("checkbox","Mouse Over","mouseover"),this.renderSetting("checkbox","Mouse Out","mouseout"))))),c.createElement(g,{eventKey:2,tab:"Running"},"beep"),c.createElement(g,{eventKey:3,tab:"Help"})))),c.createElement("div",{className:"modal-footer"},c.createElement(f,{className:"pull-left",ref:"resetDefaultsButton",onClick:this.resetDefaults},"Reset Defaults"),c.createElement(f,{ref:"cancelButton",onClick:this.props.onClose},"Close")))},renderSetting:function(a,b,d){var e=this,f=o+d;return"checkbox"===a||"radio"===a?c.createElement(i,{type:a,label:b,checked:this.props.settings.get(f),onChange:function(a){e.updateSetting(f,a.target.checked)}}):c.createElement(i,{type:a,label:b,value:this.props.settings.get(f),onChange:function(a){e.updateSetting(f,a.target.value)}})},updateSetting:function(a,b){this.props.settings.set(a,b)},saveSettings:function(a){var b=(this.refs.scenarioName.value,this.refs.description.value),c=this.refs.setupScenarios.value,d=(this.refs.cleanupScenarios.value,{});name&&(d.name=name),b&&(d.description=b),c&&(d.setup={scenarios:c.split("\n")}),a.stopPropagation()}});b.exports=m(p)},{"../mixins/UtmeMixin":219,"../modals/modal-launcher.jsx":221,react:209,"react-bootstrap":53}],223:[function(a,b){"use strict";function c(){e.appendComponent(f,{utme:d},"utme-bar")}var d=a("../js/utme"),e=a("./body"),f=a("./components/control-panel.jsx"),g={};d&&(d.state&&"INITIALIZED"==d.state.status?c():d.registerListener(function(a){"INITIALIZED"==a&&c()})),b.exports=g},{"../js/utme":216,"./body":217,"./components/control-panel.jsx":218}]},{},[210,211,212,213,214,215,216,217,219,223]);